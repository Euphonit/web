...
input_dir="/Users/daniel/Code/web/public/Photography/5"  # Replace with the actual path

# Set the directory where you want to save the WebP files
output_dir="/Users/daniel/Code/web/public/Photography/5"  # Replace with the desired output path
