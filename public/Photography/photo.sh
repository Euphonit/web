...
input_dir="/home/daniel/Code/web/public/Photography/15"  # Replace with the actual path

# Set the directory where you want to save the AVIF files
output_dir="/home/daniel/Code/web/public/Photography/15"  # Replace with the desired output path
