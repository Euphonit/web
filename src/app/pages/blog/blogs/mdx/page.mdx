...
<div className="antialiased font-medium text-center text-xl mt-2 px-4 md:px-8">
    ...
    <div className="antialiased font-medium text-center text-5xl text-clip flex items-start mt-1"> 1. Rounded Corners</div>
    <div className="mt-2">
    ...
    <div className="antialiased font-medium text-center text-5xl text-clip flex items-start mt-1"> 2. Better Buttons</div>
    <div className="mt-2">
    ...
    <div className="antialiased font-medium text-center text-5xl text-clip flex items-start mt-1"> 3. MDX</div>
    <div className="mt-2">
    ...
    <div className="antialiased font-medium text-center text-5xl text-clip flex items-start mt-1"> 4. Password API</div>
    <div className="mt-2">
