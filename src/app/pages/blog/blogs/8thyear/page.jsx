  ...
  return (
    <div>
      ...
      <div className="antialiased bg-teal-700 p-4 rounded-md w-fit mx-auto mt-4 text-center">
        <p className="font-bold text-6xl text-white">#4 My year* (May 25, 2025)</p>
        <p className="font-normal text-2xl text-gray-300 mt-0.5">*My 8th Grade School year</p>
      </div>
      <p className="antialiased font-medium text-xl text-center mt-1">
        I can't believe the year is over. I wish I had more time. Summer is soooooo boring. I don't get
        to hang out with my friends. I have so much to do this summer but I also don't have anything.
        The boring days feel like they last so long. I'm still glad I had the expirience though. I met
        some of my best friends like Onan, Addison, Hunter, Foxy, Athena, and O'neill. I also figured
        out alot about my future in life, and how I think about my life and everything.
      </p>
    </div>
  );
}
