  ...
  return (
    <div>
      ...
      <p className="--font-poppins antialiased text-3xl text-white text-center text-clip">
        My Junior High is doing Charlie and The Chocolate Factory for our
        end-of-year musical, and our guy playing Willy Wonka just quit.
      </p>
      <p className="--font-poppins antialiased text-3xl text-white text-center text-clip">
        <br />
        Our show had is split, where one show all the 7th graders are lead
        characters and one show all the 8th graders are the leads. The 7th
        grader we have playing wonka is super underprepared. The 8th grader we
        have is a really talented guy with a strong voice. The 8th grade wonka
        had skipped practice every day this week, and the theater teacher said
        he HAD to come in for today's practice (They had agreed beforehand he
        could skip all week if he went to this practice today). He walks in
