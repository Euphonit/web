    ...
    <div>
      ...
      <div className="--font-poppins antialiased bg-teal-700 p-4 rounded-md w-fit mx-auto mt-4 text-center">
        <p className="font-bold text-6xl text-white">
          #4 Minidisc (May 25, 2025)
        </p>
        <p className="font-normal text-2xl text-gray-300 mt-0.5">
          My new expensive hobby
        </p>
      </div>
      <p className="--font-poppins antialiased font-medium text-2xl text-center mt-12 px-4 md:px-8">
        ...
        disc-like format that could store up to 74 minutes of audio data, at
        near CD quality. It was also around 1/8 the size of CD and the players
        could fit in your pocket. It was huge in japan but never really found an
        audience in the US. At the festival, I bought a portable player and I
        had a recording deck in my garage. Now I can record all my mp3s onto the
        MiniDisc. Their especially useful because my school doesnt allow phones,
        so I can just listen to music on my MiniDiscs instead!
      </p>
    </div>
  );
}
