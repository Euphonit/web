    ...
    <div>
      <div className="grid grid-cols-2">
        <Link href="/pages/blog">
          <button
            className="--font-poppins antialiased text-3xl bg-blue-500 px-4 py-2 mt-1 rounded-3xl
      ...
      focus:ring-offset-2 transition-colors duration-200 active:bg-blue-700 w-full"
        ...
        <Link href="/">
          <button
            className="--font-poppins antialiased text-3xl bg-green-500 px-4 py-2 mt-1 rounded-3xl
